...
Visit our [Getting Started guide](https://docs.satia.shop/guides/getting-started/installation/) to get Vendure up and running locally in _less than 2 minutes_ with a single command.
...
Have a look at all of our [ready-made Vendure plugins](https://satia.shop/plugins?page=1).
...
Licensed under the [GPLv3 license](./LICENSE.md). Commercial license (VCL) [available](https://satia.shop/pricing).
